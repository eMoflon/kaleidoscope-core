...
public class SimpleJavaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SimpleJavaPackage.JAVA_VARIABLE_DECLARATION: {
			...
			if (result == null)
				result = caseJavaExpression(javaVariableDeclaration);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SimpleJavaPackage.JAVA_OPAQUE_METHOD: {
			...
			if (result == null)
				result = caseJavaMethod(javaOpaqueMethod);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SimpleJavaPackage.JAVA_WORKFLOW_METHOD: {
			...
			if (result == null)
				result = caseJavaMethod(javaWorkflowMethod);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case SimpleJavaPackage.JAVA_UNKNOWN_STATEMENT: {
			...
			if (result == null)
				result = caseJavaStatement(javaUnknownStatement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case SimpleJavaPackage.JAVA_METHOD_INVOCATION: {
			...
			if (result == null)
				result = caseJavaExpression(javaMethodInvocation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SimpleJavaPackage.JAVA_ASSIGNMENT: {
			...
			if (result == null)
				result = caseJavaExpression(javaAssignment);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SimpleJavaPackage.JAVA_LITERAL: {
			...
			if (result == null)
				result = caseJavaExpression(javaLiteral);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SimpleJavaPackage.JAVA_NAME: {
			...
			if (result == null)
				result = caseJavaExpression(javaName);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SimpleJavaPackage.JAVA_ARRAY_INIT: {
			...
			if (result == null)
				result = caseJavaExpression(javaArrayInit);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
