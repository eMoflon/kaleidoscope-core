...
public class JavaAssignmentImpl extends JavaExpressionImpl implements JavaAssignment {
	...
	public NotificationChain basicSetRhs(JavaExpression newRhs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_ASSIGNMENT__RHS, oldRhs, newRhs);
	...
	public void setRhs(JavaExpression newRhs) {
		if (newRhs != rhs) {
			...
			if (rhs != null)
				msgs = ((InternalEObject)rhs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.JAVA_ASSIGNMENT__RHS, null, msgs);
			if (newRhs != null)
				msgs = ((InternalEObject)newRhs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.JAVA_ASSIGNMENT__RHS, null, msgs);
			msgs = basicSetRhs(newRhs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_ASSIGNMENT__RHS, newRhs, newRhs));
	}
	...
	public NotificationChain basicSetLhs(JavaExpression newLhs, NotificationChain msgs) {
		...
		lhs = newLhs;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_ASSIGNMENT__LHS, oldLhs, newLhs);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLhs(JavaExpression newLhs) {
		if (newLhs != lhs) {
			NotificationChain msgs = null;
			if (lhs != null)
				msgs = ((InternalEObject)lhs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.JAVA_ASSIGNMENT__LHS, null, msgs);
			if (newLhs != null)
				msgs = ((InternalEObject)newLhs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.JAVA_ASSIGNMENT__LHS, null, msgs);
			msgs = basicSetLhs(newLhs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_ASSIGNMENT__LHS, newLhs, newLhs));
	}
