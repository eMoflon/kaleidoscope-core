 ...
 * @generated
 */
public class JavaCompilationUnitImpl extends MinimalEObjectImpl.Container implements JavaCompilationUnit {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_COMPILATION_UNIT__NAME, oldName, name));
	}
	...
	public EList<JavaImport> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<JavaImport>(JavaImport.class, this, SimpleJavaPackage.JAVA_COMPILATION_UNIT__IMPORTS);
		}
		return imports;
	}
	...
	public EList<JavaMethod> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentEList<JavaMethod>(JavaMethod.class, this, SimpleJavaPackage.JAVA_COMPILATION_UNIT__METHODS);
		}
		return methods;
	}
	...
	public void setFieldDeclarations(String newFieldDeclarations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_COMPILATION_UNIT__FIELD_DECLARATIONS, oldFieldDeclarations, fieldDeclarations));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimpleJavaPackage.JAVA_COMPILATION_UNIT__FIELD_DECLARATIONS:
				return FIELD_DECLARATIONS_EDEFAULT == null ? fieldDeclarations != null : !FIELD_DECLARATIONS_EDEFAULT.equals(fieldDeclarations);
		}
