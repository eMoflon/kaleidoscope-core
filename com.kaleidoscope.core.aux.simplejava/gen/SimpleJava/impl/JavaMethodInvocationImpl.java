...
public class JavaMethodInvocationImpl extends JavaExpressionImpl implements JavaMethodInvocation {
	...
	public EList<JavaExpression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<JavaExpression>(JavaExpression.class, this,
					SimpleJavaPackage.JAVA_METHOD_INVOCATION__ARGUMENTS);
		}
		return arguments;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_METHOD_INVOCATION__NAME,
					oldName, name));
	}
	...
	public void setInitialization(boolean newInitialization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					SimpleJavaPackage.JAVA_METHOD_INVOCATION__INITIALIZATION, oldInitialization, initialization));
	}
	...
	public NotificationChain basicSetOptionalExpression(JavaExpression newOptionalExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SimpleJavaPackage.JAVA_METHOD_INVOCATION__OPTIONAL_EXPRESSION, oldOptionalExpression,
					newOptionalExpression);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOptionalExpression(JavaExpression newOptionalExpression) {
		if (newOptionalExpression != optionalExpression) {
			...
			if (optionalExpression != null)
				msgs = ((InternalEObject) optionalExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.JAVA_METHOD_INVOCATION__OPTIONAL_EXPRESSION, null,
						msgs);
			if (newOptionalExpression != null)
				msgs = ((InternalEObject) newOptionalExpression).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.JAVA_METHOD_INVOCATION__OPTIONAL_EXPRESSION, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					SimpleJavaPackage.JAVA_METHOD_INVOCATION__OPTIONAL_EXPRESSION, newOptionalExpression,
					newOptionalExpression));
	}
