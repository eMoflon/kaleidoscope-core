...
public class OperationalDelta implements Delta {
	   ...
	   public void createFromEMFOperationalDelta(KaleidoscopeDelta.OperationalDelta operationalDelta){
	   ...
	   public OperationalDelta(KaleidoscopeDelta.OperationalDelta operationalDelta){
	   ...
	   public KaleidoscopeDelta.OperationalDelta transformIntoOperationalDelta(){
