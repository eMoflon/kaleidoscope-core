 ...
 * @generated
 */
public class JavaStatementImpl extends EObjectImpl implements JavaStatement {
	/**
	...
	public NotificationChain basicSetNext(JavaStatement newNext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SimpleJavaPackage.JAVA_STATEMENT__NEXT, oldNext, newNext);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newNext != next) {
			...
			if (next != null)
				msgs = ((InternalEObject) next).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.JAVA_STATEMENT__NEXT, null, msgs);
			if (newNext != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_STATEMENT__NEXT, newNext,
					newNext));
	}
	...
	public NotificationChain basicSetPrev(JavaStatement newPrev, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SimpleJavaPackage.JAVA_STATEMENT__PREV, oldPrev, newPrev);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setPrev(JavaStatement newPrev) {
		if (newPrev != prev) {
			NotificationChain msgs = null;
			if (prev != null)
				msgs = ((InternalEObject) prev).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.JAVA_STATEMENT__PREV, null, msgs);
			if (newPrev != null)
				msgs = ((InternalEObject) newPrev).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.JAVA_STATEMENT__PREV, null, msgs);
			msgs = basicSetPrev(newPrev, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_STATEMENT__PREV, newPrev,
					newPrev));
	}
	...
	public NotificationChain basicSetExpr(JavaExpression newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SimpleJavaPackage.JAVA_STATEMENT__EXPR, oldExpr, newExpr);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.JAVA_STATEMENT__EXPR, null, msgs);
			if (newExpr != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_STATEMENT__EXPR, newExpr,
					newExpr));
	}
	...
	public void setReturn(boolean newReturn) {
		...
		return_ = newReturn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.JAVA_STATEMENT__RETURN, oldReturn,
					return_));
	}
